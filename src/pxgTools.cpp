...
DECLP(PFNGLBINDTRANSFORMFEEDBACKPROC, glBindTransformFeedback)
DECLP(PFNGLBEGINTRANSFORMFEEDBACKPROC, glBeginTransformFeedback)
...
void pxgInitExtensions()
{
    ...
    GETP(PFNGLBINDTRANSFORMFEEDBACKPROC, glBindTransformFeedback)
    GETP(PFNGLBEGINTRANSFORMFEEDBACKPROC, glBeginTransformFeedback)
