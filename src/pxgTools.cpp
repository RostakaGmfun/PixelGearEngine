...
DECLP(PFNGLGENTRANSFORMFEEDBACKSPROC, glGenTransformFeedbacks)
DECLP(PFNGLBINDTRANSFORMFEEDBACKPROC, glBindTransfromFeedback)
DECLP(PFNGLBEGINTRANSFORMFEEDBACKPROC, glBeginTransfromFeedback)
DECLP(PFNGLENDTRANSFORMFEEDBACKPROC, glEndTransformFeedback)
DECLP(PFNGLDRAWTRANSFORMFEEDBACKPROC, glDrawTransformFeedback)
DECLP(PFNGLTRANSFORMFEEDBACKVARYINGSPROC, glTransformFeedbackVaryings)
DECLP(PFNGLBINDBUFFERBASEPROC, glBindBufferBase)
...
void pxgInitExtensions()
{
    ...
    GETP(PFNGLGENTRANSFORMFEEDBACKSPROC, glGenTransformFeedbacks)
    GETP(PFNGLBINDTRANSFORMFEEDBACKPROC, glBindTransfromFeedback)
    GETP(PFNGLBEGINTRANSFORMFEEDBACKPROC, glBeginTransfromFeedback)
    GETP(PFNGLENDTRANSFORMFEEDBACKPROC, glEndTransformFeedback)
    GETP(PFNGLDRAWTRANSFORMFEEDBACKPROC, glDrawTransformFeedback)
    GETP(PFNGLTRANSFORMFEEDBACKVARYINGSPROC, glTransformFeedbackVaryings)
    GETP(PFNGLBINDBUFFERBASEPROC, glBindBufferBase)
